...
\setlength{\emergencystretch}{3em} % Prevent text from going out of bounds
\usepackage{setspace}
\onehalfspacing
...
\input{chapters/02_vision_mission}
\input{chapters/03_project_overview}
\input{chapters/04_system_architecture}
\input{chapters/05_technology_stack}
\input{chapters/06_frontend}
\input{chapters/07_navigation}
\input{chapters/08_backend}
\input{chapters/09_database}
\input{chapters/10_ml_module}
\input{chapters/11_ml_analysis}
\input{chapters/12_ml_pipeline}
\input{chapters/13_api_documentation}
\input{chapters/14_workflow}
\input{chapters/15_deployment}
\input{chapters/16_results}
\input{chapters/17_challenges}
\input{chapters/18_limitations}
\input{chapters/19_future}
