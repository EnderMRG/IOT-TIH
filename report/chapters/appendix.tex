...
\section{Model Configuration (\texttt{config.\allowbreak{}json})}
...
\section{Scaler Parameters (\texttt{scalers.\allowbreak{}json}) -- Excerpt}
...
\section{ESP32 Firmware (\texttt{IOTcode.\allowbreak{}ino})}
