...
Implement the \texttt{/\allowbreak{}api/\allowbreak{}flood-predict} endpoint using \texttt{@tensorflow/\allowbreak{}tfjs-node}, allowing server-side prediction for clients without WebGL support (IoT displays, kiosk terminals, old mobile browsers).
