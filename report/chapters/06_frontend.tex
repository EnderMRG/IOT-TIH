...
The FloodEye frontend is a Next.js 16 App Router application. All pages live under either the root \texttt{/\allowbreak{}} (landing) or the nested \texttt{/\allowbreak{}dashboard/\allowbreak{}} route group. This chapter describes each page in detail.

\section{Landing Page (\texttt{app/\allowbreak{}page.\allowbreak{}tsx})}
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{ScrollytellingSections:} The primary content component. Uses GSAP ScrollTrigger to animate content sections as the user scrolls: Hero, Problem Statement, Features Showcase, Technology Stack, Team Profiles (with individual member photos from \texttt{/\allowbreak{}public/\allowbreak{}}), and a call-to-action.
...
\section{Dashboard Home (\texttt{app/\allowbreak{}dashboard/\allowbreak{}page.\allowbreak{}tsx})}
...
\section{Analytics Page (\texttt{app/\allowbreak{}dashboard/\allowbreak{}analytics/\allowbreak{}page.\allowbreak{}tsx})}
...
\subsection{Components}
\begin{itemize}[leftmargin=1.5em]
  \item \textbf{TimeFilter:} A pill-tab selector for 1h, 6h, 24h, 7d, 30d windows. Selecting a window triggers a new \texttt{/\allowbreak{}api/\allowbreak{}history?range=\{window\}} request.
...
\section{History Page (\texttt{app/\allowbreak{}dashboard/\allowbreak{}history/\allowbreak{}page.\allowbreak{}tsx})}
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{Export buttons:}
    \begin{itemize}
      \item \textbf{CSV Export:} Generates a Blob from the history array and downloads it as \texttt{floodeye\_\allowbreak{}logs\_\allowbreak{}\{date\}.csv}.
      \item \textbf{PDF Export:} Uses jsPDF + jspdf-autotable to generate a formatted PDF with the FloodEye header and a data table.
    \end{itemize}
\end{itemize}

\section{Predictions Page (\texttt{app/\allowbreak{}dashboard/\allowbreak{}predictions/\allowbreak{}page.\allowbreak{}tsx})}
...
\section{Alerts Page (\texttt{app/\allowbreak{}dashboard/\allowbreak{}alerts/\allowbreak{}page.\allowbreak{}tsx})}
...
\section{Settings Page (\texttt{app/\allowbreak{}dashboard/\allowbreak{}settings/\allowbreak{}page.\allowbreak{}tsx})}
...
\section{Devices Page (\texttt{app/\allowbreak{}dashboard/\allowbreak{}devices/\allowbreak{}})}
