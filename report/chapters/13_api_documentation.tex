...
This chapter documents all implemented API endpoints in FloodEye. Each endpoint is a Next.js Route Handler deployed as a Vercel serverless function under \texttt{app/\allowbreak{}api/\allowbreak{}}.

\section{Base URL}

\begin{itemize}[leftmargin=1.5em]
  \item \textbf{Development:} \texttt{http:/\allowbreak{}/\allowbreak{}localhost:3000}
  \item \textbf{Production:} \texttt{https:/\allowbreak{}/\allowbreak{}\{project\}.vercel.app}
\end{itemize}
...
\begin{itemize}[leftmargin=1.5em]
  \item \texttt{Content-Type: application/\allowbreak{}json}
...
7d & Date range & \texttt{start=.\allowbreak{}.\allowbreak{}.\allowbreak{}\&end=.\allowbreak{}.\allowbreak{}.\allowbreak{}} \\
30d & Date range & \texttt{start=.\allowbreak{}.\allowbreak{}.\allowbreak{}\&end=.\allowbreak{}.\allowbreak{}.\allowbreak{}} \\
\hline
\end{tabular}
\end{table}
...
\subsection{Query Parameters}
Same \texttt{range} parameter as \texttt{/\allowbreak{}api/\allowbreak{}history}. Default: \texttt{24h}.
...
\subsection{Purpose}
Structural placeholder for future server-side TensorFlow.js Node.js inference. In the current implementation, actual inference runs client-side via \texttt{lib/\allowbreak{}flood-model.\allowbreak{}ts}.
...
400 & Insufficient data (\texttt{history.\allowbreak{}length < 48}) \\
...
The current implementation does not implement API-level authentication. Environment variables (\texttt{THINGSPEAK\_\allowbreak{}CHANNEL\_\allowbreak{}ID}, \texttt{THINGSPEAK\_\allowbreak{}READ\_\allowbreak{}API\_\allowbreak{}KEY}) are kept server-side only and are never exposed to the client. The ThingSpeak Read API Key provides read-only access to the channel and does not expose write credentials.
...
\hline
\texttt{THINGSPEAK\_\allowbreak{}CHANNEL\_\allowbreak{}ID} & Server-only & ThingSpeak channel numeric ID \\
\texttt{THINGSPEAK\_\allowbreak{}READ\_\allowbreak{}API\_\allowbreak{}KEY} & Server-only & ThingSpeak read-only API key \\
\texttt{NEXT\_\allowbreak{}PUBLIC\_\allowbreak{}MAPTILER\_\allowbreak{}KEY} & Public (client) & MapTiler API key for map tile service \\
\hline
\end{tabularx}
\end{table}
