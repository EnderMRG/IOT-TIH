...
Server-side ML inference & Planned & \texttt{/api/flood-predict} placeholder exists \\
\hline
\end{tabularx}
\end{table}
...
\begin{itemize}[leftmargin=1.5em]
  \item The glassmorphism design (\texttt{bg-white/40 backdrop-blur-xl}) provides a visually distinctive and modern interface well-suited for an emergency monitoring context.
